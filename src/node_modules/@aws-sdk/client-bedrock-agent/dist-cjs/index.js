...
var FlowNodeConfigurationFilterSensitiveLog = /* @__PURE__ */ __name((obj) => {
  ...
  if (obj.knowledgeBase !== void 0) return { knowledgeBase: obj.knowledgeBase };
...
var se_FlowNodeConfiguration = /* @__PURE__ */ __name((input, context) => {
  return FlowNodeConfiguration.visit(input, {
    ...
    knowledgeBase: /* @__PURE__ */ __name((value) => ({ knowledgeBase: (0, import_smithy_client._json)(value) }), "knowledgeBase"),
